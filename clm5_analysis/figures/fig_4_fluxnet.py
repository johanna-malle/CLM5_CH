...
CH_Aws_daily = pd.read_csv(bf / 'CH-Aws_flux_diff_daily.csv')
CH_Cha_daily = pd.read_csv(bf / 'CH-Cha_flux_diff_daily.csv')
CH_Dav_daily = pd.read_csv(bf / 'CH-Dav_flux_diff_daily.csv')
CH_Fru_daily = pd.read_csv(bf / 'CH-Fru_flux_diff_daily.csv')
CH_Lae_daily = pd.read_csv(bf / 'CH-Lae_flux_diff_daily.csv')
CH_Oe2_daily = pd.read_csv(bf / 'CH-Oe2_flux_diff_daily.csv')


df_Aws_lh = pd.melt(np.abs(CH_Aws[['cru_05_lh', 'cru_1km_lh', 'cru_plus_05_lh', 'cru_plus_1km_lh', 'oshd_05_lh',
                                   'oshd_1km_lh']]), var_name="model_run", value_name="lh")
df_Aws_lh['site'] = "CH-Aws"

df_Cha_lh = pd.melt(np.abs(CH_Cha[['cru_05_lh', 'cru_1km_lh', 'cru_plus_05_lh', 'cru_plus_1km_lh', 'oshd_05_lh',
                                   'oshd_1km_lh']]), var_name="model_run", value_name="lh")
df_Cha_lh['site'] = "CH-Cha"

df_Dav_lh = pd.melt(np.abs(CH_Dav[['cru_05_lh', 'cru_1km_lh', 'cru_plus_05_lh', 'cru_plus_1km_lh', 'oshd_05_lh',
                                   'oshd_1km_lh']]), var_name="model_run", value_name="lh")
df_Dav_lh['site'] = "CH-Dav"

df_Fru_lh = pd.melt(np.abs(CH_Fru[['cru_05_lh', 'cru_1km_lh', 'cru_plus_05_lh', 'cru_plus_1km_lh', 'oshd_05_lh',
                                   'oshd_1km_lh']]), var_name="model_run", value_name="lh")
df_Fru_lh['site'] = "CH-Fru"

df_Lae_lh = pd.melt(np.abs(CH_Lae[['cru_05_lh', 'cru_1km_lh', 'cru_plus_05_lh', 'cru_plus_1km_lh', 'oshd_05_lh',
                                   'oshd_1km_lh']]), var_name="model_run", value_name="lh")
df_Lae_lh['site'] = "CH-Lae"

df_Oe2_lh = pd.melt(np.abs(CH_Oe2[['cru_05_lh', 'cru_1km_lh', 'cru_plus_05_lh', 'cru_plus_1km_lh', 'oshd_05_lh',
                                   'oshd_1km_lh']]), var_name="model_run", value_name="lh")
...
# now AET
df_Aws_aet = pd.melt(np.abs(CH_Aws_daily[['cru_05_aet_daily', 'cru_1km_aet_daily', 'cru_plus_05_aet_daily', 'cru_plus_1km_aet_daily', 'oshd_05_aet_daily',
                                   'oshd_1km_aet_daily']]), var_name="model_run", value_name="aet")
df_Aws_aet['site'] = "CH-Aws"

df_Cha_aet = pd.melt(np.abs(CH_Cha_daily[['cru_05_aet_daily', 'cru_1km_aet_daily', 'cru_plus_05_aet_daily', 'cru_plus_1km_aet_daily', 'oshd_05_aet_daily',
                                   'oshd_1km_aet_daily']]), var_name="model_run", value_name="aet")
df_Cha_aet['site'] = "CH-Cha"

df_Dav_aet = pd.melt(np.abs(CH_Dav_daily[['cru_05_aet_daily', 'cru_1km_aet_daily', 'cru_plus_05_aet_daily', 'cru_plus_1km_aet_daily', 'oshd_05_aet_daily',
                                   'oshd_1km_aet_daily']]), var_name="model_run", value_name="aet")
df_Dav_aet['site'] = "CH-Dav"

df_Fru_aet = pd.melt(np.abs(CH_Fru_daily[['cru_05_aet_daily', 'cru_1km_aet_daily', 'cru_plus_05_aet_daily', 'cru_plus_1km_aet_daily', 'oshd_05_aet_daily',
                                   'oshd_1km_aet_daily']]), var_name="model_run", value_name="aet")
df_Fru_aet['site'] = "CH-Fru"

df_Lae_aet = pd.melt(np.abs(CH_Lae_daily[['cru_05_aet_daily', 'cru_1km_aet_daily', 'cru_plus_05_aet_daily', 'cru_plus_1km_aet_daily', 'oshd_05_aet_daily',
                                   'oshd_1km_aet_daily']]), var_name="model_run", value_name="aet")
df_Lae_aet['site'] = "CH-Lae"

df_Oe2_aet = pd.melt(np.abs(CH_Oe2_daily[['cru_05_aet_daily', 'cru_1km_aet_daily', 'cru_plus_05_aet_daily', 'cru_plus_1km_aet_daily', 'oshd_05_aet_daily',
                                   'oshd_1km_aet_daily']]), var_name="model_run", value_name="aet")
df_Oe2_aet['site'] = "CH-Oe2"

frames = [df_Aws_aet, df_Cha_aet, df_Dav_aet, df_Fru_aet, df_Lae_aet, df_Oe2_aet]
combined_aet = pd.concat(frames)

# now sensible heat
df_Aws_sh = pd.melt(np.abs(CH_Aws[['cru_05_sh', 'cru_1km_sh', 'cru_plus_05_sh', 'cru_plus_1km_sh', 'oshd_05_sh',
                                   'oshd_1km_sh']]), var_name="model_run", value_name="sh")
df_Aws_sh['site'] = "CH-Aws"

df_Cha_sh = pd.melt(np.abs(CH_Cha[['cru_05_sh', 'cru_1km_sh', 'cru_plus_05_sh', 'cru_plus_1km_sh', 'oshd_05_sh',
                                   'oshd_1km_sh']]), var_name="model_run", value_name="sh")
df_Cha_sh['site'] = "CH-Cha"

df_Dav_sh = pd.melt(np.abs(CH_Dav[['cru_05_sh', 'cru_1km_sh', 'cru_plus_05_sh', 'cru_plus_1km_sh', 'oshd_05_sh',
                                   'oshd_1km_sh']]), var_name="model_run", value_name="sh")
df_Dav_sh['site'] = "CH-Dav"

df_Fru_sh = pd.melt(np.abs(CH_Fru[['cru_05_sh', 'cru_1km_sh', 'cru_plus_05_sh', 'cru_plus_1km_sh', 'oshd_05_sh',
                                   'oshd_1km_sh']]), var_name="model_run", value_name="sh")
df_Fru_sh['site'] = "CH-Fru"

df_Lae_sh = pd.melt(np.abs(CH_Lae[['cru_05_sh', 'cru_1km_sh', 'cru_plus_05_sh', 'cru_plus_1km_sh', 'oshd_05_sh',
                                   'oshd_1km_sh']]), var_name="model_run", value_name="sh")
df_Lae_sh['site'] = "CH-Lae"

df_Oe2_sh = pd.melt(np.abs(CH_Oe2[['cru_05_sh', 'cru_1km_sh', 'cru_plus_05_sh', 'cru_plus_1km_sh', 'oshd_05_sh',
                                   'oshd_1km_sh']]), var_name="model_run", value_name="sh")
...
# now gpp
df_Aws_gpp = pd.melt(np.abs(CH_Aws[['cru_05_gpp', 'cru_1km_gpp', 'cru_plus_05_gpp', 'cru_plus_1km_gpp', 'oshd_05_gpp',
                                    'oshd_1km_gpp']]), var_name="model_run", value_name="gpp")
df_Aws_gpp['site'] = "CH-Aws"

df_Cha_gpp = pd.melt(np.abs(CH_Cha[['cru_05_gpp', 'cru_1km_gpp', 'cru_plus_05_gpp', 'cru_plus_1km_gpp', 'oshd_05_gpp',
                                    'oshd_1km_gpp']]), var_name="model_run", value_name="gpp")
df_Cha_gpp['site'] = "CH-Cha"

df_Dav_gpp = pd.melt(np.abs(CH_Dav[['cru_05_gpp', 'cru_1km_gpp', 'cru_plus_05_gpp', 'cru_plus_1km_gpp', 'oshd_05_gpp',
                                    'oshd_1km_gpp']]), var_name="model_run", value_name="gpp")
df_Dav_gpp['site'] = "CH-Dav"

df_Fru_gpp = pd.melt(np.abs(CH_Fru[['cru_05_gpp', 'cru_1km_gpp', 'cru_plus_05_gpp', 'cru_plus_1km_gpp', 'oshd_05_gpp',
                                    'oshd_1km_gpp']]), var_name="model_run", value_name="gpp")
df_Fru_gpp['site'] = "CH-Fru"

df_Lae_gpp = pd.melt(np.abs(CH_Lae[['cru_05_gpp', 'cru_1km_gpp', 'cru_plus_05_gpp', 'cru_plus_1km_gpp', 'oshd_05_gpp',
                                    'oshd_1km_gpp']]), var_name="model_run", value_name="gpp")
df_Lae_gpp['site'] = "CH-Lae"

df_Oe2_gpp = pd.melt(np.abs(CH_Oe2[['cru_05_gpp', 'cru_1km_gpp', 'cru_plus_05_gpp', 'cru_plus_1km_gpp', 'oshd_05_gpp',
                                    'oshd_1km_gpp']]), var_name="model_run", value_name="gpp")
...
# now gpp daily
df_Aws_gpp_daily = pd.melt(np.abs(CH_Aws_daily[['cru_05_gpp_daily', 'cru_1km_gpp_daily', 'cru_plus_05_gpp_daily', 'cru_plus_1km_gpp_daily', 'oshd_05_gpp_daily',
                                    'oshd_1km_gpp_daily']]), var_name="model_run", value_name="gpp")
df_Aws_gpp_daily['site'] = "CH-Aws"

df_Cha_gpp_daily = pd.melt(np.abs(CH_Cha_daily[['cru_05_gpp_daily', 'cru_1km_gpp_daily', 'cru_plus_05_gpp_daily', 'cru_plus_1km_gpp_daily', 'oshd_05_gpp_daily',
                                    'oshd_1km_gpp_daily']]), var_name="model_run", value_name="gpp")
df_Cha_gpp_daily['site'] = "CH-Cha"

df_Dav_gpp_daily = pd.melt(np.abs(CH_Dav_daily[['cru_05_gpp_daily', 'cru_1km_gpp_daily', 'cru_plus_05_gpp_daily', 'cru_plus_1km_gpp_daily', 'oshd_05_gpp_daily',
                                    'oshd_1km_gpp_daily']]), var_name="model_run", value_name="gpp")
df_Dav_gpp_daily['site'] = "CH-Dav"

df_Fru_gpp_daily = pd.melt(np.abs(CH_Fru_daily[['cru_05_gpp_daily', 'cru_1km_gpp_daily', 'cru_plus_05_gpp_daily', 'cru_plus_1km_gpp_daily', 'oshd_05_gpp_daily',
                                    'oshd_1km_gpp_daily']]), var_name="model_run", value_name="gpp")
df_Fru_gpp_daily['site'] = "CH-Fru"

df_Lae_gpp_daily = pd.melt(np.abs(CH_Lae_daily[['cru_05_gpp_daily', 'cru_1km_gpp_daily', 'cru_plus_05_gpp_daily', 'cru_plus_1km_gpp_daily', 'oshd_05_gpp_daily',
                                    'oshd_1km_gpp_daily']]), var_name="model_run", value_name="gpp")
df_Lae_gpp_daily['site'] = "CH-Lae"

df_Oe2_gpp_daily = pd.melt(np.abs(CH_Oe2_daily[['cru_05_gpp_daily', 'cru_1km_gpp_daily', 'cru_plus_05_gpp_daily', 'cru_plus_1km_gpp_daily', 'oshd_05_gpp_daily',
                                    'oshd_1km_gpp_daily']]), var_name="model_run", value_name="gpp")
df_Oe2_gpp_daily['site'] = "CH-Oe2"

frames = [df_Aws_gpp_daily, df_Cha_gpp_daily, df_Dav_gpp_daily, df_Fru_gpp_daily, df_Lae_gpp_daily, df_Oe2_gpp_daily]
combined_gpp_daily = pd.concat(frames)
...
frames = [np.abs(CH_Aws_daily[['cru_05_aet_daily', 'cru_1km_aet_daily', 'cru_plus_05_aet_daily', 'cru_plus_1km_aet_daily', 'oshd_05_aet_daily', 'oshd_1km_aet_daily']]),
          np.abs(CH_Cha_daily[['cru_05_aet_daily', 'cru_1km_aet_daily', 'cru_plus_05_aet_daily', 'cru_plus_1km_aet_daily', 'oshd_05_aet_daily', 'oshd_1km_aet_daily']]),
          np.abs(CH_Dav_daily[['cru_05_aet_daily', 'cru_1km_aet_daily', 'cru_plus_05_aet_daily', 'cru_plus_1km_aet_daily', 'oshd_05_aet_daily', 'oshd_1km_aet_daily']]),
          np.abs(CH_Fru_daily[['cru_05_aet_daily', 'cru_1km_aet_daily', 'cru_plus_05_aet_daily', 'cru_plus_1km_aet_daily', 'oshd_05_aet_daily', 'oshd_1km_aet_daily']]),
          np.abs(CH_Lae_daily[['cru_05_aet_daily', 'cru_1km_aet_daily', 'cru_plus_05_aet_daily', 'cru_plus_1km_aet_daily', 'oshd_05_aet_daily', 'oshd_1km_aet_daily']]),
          np.abs(CH_Oe2_daily[['cru_05_aet_daily', 'cru_1km_aet_daily', 'cru_plus_05_aet_daily', 'cru_plus_1km_aet_daily', 'oshd_05_aet_daily', 'oshd_1km_aet_daily']])]
dh_aet = pd.concat(frames)

frames = [np.abs(CH_Aws_daily[['cru_05_gpp_daily', 'cru_1km_gpp_daily', 'cru_plus_05_gpp_daily', 'cru_plus_1km_gpp_daily', 'oshd_05_gpp_daily', 'oshd_1km_gpp_daily']]),
          np.abs(CH_Cha_daily[['cru_05_gpp_daily', 'cru_1km_gpp_daily', 'cru_plus_05_gpp_daily', 'cru_plus_1km_gpp_daily', 'oshd_05_gpp_daily', 'oshd_1km_gpp_daily']]),
          np.abs(CH_Dav_daily[['cru_05_gpp_daily', 'cru_1km_gpp_daily', 'cru_plus_05_gpp_daily', 'cru_plus_1km_gpp_daily', 'oshd_05_gpp_daily', 'oshd_1km_gpp_daily']]),
          np.abs(CH_Fru_daily[['cru_05_gpp_daily', 'cru_1km_gpp_daily', 'cru_plus_05_gpp_daily', 'cru_plus_1km_gpp_daily', 'oshd_05_gpp_daily', 'oshd_1km_gpp_daily']]),
          np.abs(CH_Lae_daily[['cru_05_gpp_daily', 'cru_1km_gpp_daily', 'cru_plus_05_gpp_daily', 'cru_plus_1km_gpp_daily', 'oshd_05_gpp_daily', 'oshd_1km_gpp_daily']]),
          np.abs(CH_Oe2_daily[['cru_05_gpp_daily', 'cru_1km_gpp_daily', 'cru_plus_05_gpp_daily', 'cru_plus_1km_gpp_daily', 'oshd_05_gpp_daily', 'oshd_1km_gpp_daily']])]
dh_gpp_daily = pd.concat(frames)
...
my_pal_gpp_daily = {"oshd_1km_gpp_daily": (27/255, 158/255, 119/255), "oshd_05_gpp_daily": (27/255, 158/255, 119/255),
              "cru_plus_1km_gpp_daily": (117/255, 112/255, 179/255), "cru_plus_05_gpp_daily": (117/255, 112/255, 179/255),
              "cru_1km_gpp_daily": (217/255, 95/255, 2/255), "cru_05_gpp_daily": (217/255, 95/255, 2/255)}

my_pal_aet_daily = {"oshd_1km_aet_daily": (27/255, 158/255, 119/255), "oshd_05_aet_daily": (27/255, 158/255, 119/255),
              "cru_plus_1km_aet_daily": (117/255, 112/255, 179/255), "cru_plus_05_aet_daily": (117/255, 112/255, 179/255),
              "cru_1km_aet_daily": (217/255, 95/255, 2/255), "cru_05_aet_daily": (217/255, 95/255, 2/255)}
...
gpp_act_daily = combined_gpp_daily[~np.isnan(combined_gpp_daily.gpp)].reset_index(drop=True)
...
aet_act = combined_aet[~np.isnan(combined_aet.aet)].reset_index(drop=True)
...
normed_aet = scaler.fit_transform(np.array(aet_act.aet).reshape(-1, 1))
normed_gpp_daily = scaler.fit_transform(np.array(gpp_act_daily.gpp).reshape(-1, 1))

gpp_act_norm = gpp_act.copy()
gpp_act_norm['gpp'] = normed_gpp
gpp_act_norm_daily = gpp_act_daily.copy()
gpp_act_norm_daily['gpp'] = normed_gpp_daily
sh_act_norm = sh_act.copy()
sh_act_norm['sh'] = normed_sh
lh_act_norm = lh_act.copy()
lh_act_norm['lh'] = normed_lh
aet_act_norm = aet_act.copy()
aet_act_norm['aet'] = normed_aet
...
lme_out_gpp_daily = smf.mixedlm('gpp ~ model_run', gpp_act_daily, groups=gpp_act_daily['site'])
lme_fit_gpp_daily = lme_out_gpp_daily.fit()
lme_out_gpp_daily_norm = smf.mixedlm('gpp ~ model_run', gpp_act_norm_daily, groups=gpp_act_norm_daily['site'])
lme_fit_gpp_daily_norm = lme_out_gpp_daily_norm.fit()
...
lme_out_aet = smf.mixedlm('aet ~ model_run', aet_act, groups=aet_act['site'])
lme_fit_aet = lme_out_lh.fit()
lme_out_aet_norm = smf.mixedlm('aet ~ model_run', aet_act_norm, groups=aet_act_norm['site'])
lme_fit_aet_norm = lme_out_aet_norm.fit()

flp = dict(marker='o', markersize=4.5, markeredgecolor='gray', markerfacecolor='silver', alpha=0.45)
...
ax = sns.boxplot(x="site", y="lh", hue="model_run", palette=my_pal_lh, data=combined_lh, flierprops=flp, showmeans=True,
                 meanprops={"marker": "o", "markerfacecolor": "w", "markeredgecolor": "k",  "markersize": "4"},
                 medianprops=dict(color="grey", alpha=0.85, linewidth=1.9, linestyle='-'), linewidth=1.6,
                 saturation=0.8, showfliers=False)
...
for patch in ax1.patches[1:10:4]:
    r, g, b, a = patch.get_facecolor()
...
a = np.asarray([[[st_1[0], 1], [st_2[0], 1]], [[st_1[1], 2], [st_2[1], 2]], [[st_1[2], 3], [st_2[2], 3]],
                [[st_1[3], 4], [st_2[3], 4]], [[st_1[4], 5], [st_2[4], 5]]])
X = a[:, :, 0].T
Y = a[:, :, 1].T

for i in range(1, 6):
    if i in [1, 3, 5]:
        plt.plot(np.array(a1['Coef.'].values[i]).astype('float'), i, 'o', 'filled', color=color_all[i-1],
...
fig = plt.figure(layout="constrained", figsize=(14, 6))
ax1 = plt.subplot2grid(shape=(5, 1), loc=(0, 0), rowspan=4)
ax = sns.boxplot(x="site", y="aet", hue="model_run", palette=my_pal_aet_daily, data=combined_aet, flierprops=flp, showmeans=True,
                 meanprops={"marker": "o", "markerfacecolor": "w", "markeredgecolor": "k",  "markersize": "4"},
                 medianprops=dict(color="grey", alpha=0.85, linewidth=1.9, linestyle='-'), linewidth=1.6,
                 saturation=0.8, showfliers=False)
sns.despine(offset=10, trim=True)
plt.ylabel('($\Delta$ AET)$_{abs}$ [mm]', fontsize=17)
plt.xlabel('')
...
ti1 = ax1.set_title('(a)', loc='left', x=-0.09, y=1.03, pad=-24, fontsize=18, fontweight='bold')
ax1a = plt.subplot2grid(shape=(5, 1), loc=(4, 0), rowspan=1)
a1 = lme_fit_aet.summary().tables[1]
st_1 = a1['[0.025'][1:-1].values.astype('float')
st_2 = a1['0.975]'][1:-1].values.astype('float')
a = np.asarray([[[st_1[0], 1], [st_2[0], 1]], [[st_1[1], 2], [st_2[1], 2]], [[st_1[2], 3], [st_2[2], 3]],
                [[st_1[3], 4], [st_2[3], 4]], [[st_1[4], 5], [st_2[4], 5]]])
...
plt.show()
fig.savefig(bf / 'figure_4_a_aet.png', facecolor='white', transparent=False)
fig.savefig(bf / 'figure_4_a_aet.pdf', facecolor='white', transparent=False)


# now sensible heat
fig = plt.figure(layout="constrained", figsize=(14, 6))
ax2 = plt.subplot2grid(shape=(5, 1), loc=(0, 0), rowspan=4)
ax = sns.boxplot(x="site", y="sh", hue="model_run", palette=my_pal_sh, data=combined_sh, flierprops=flp, showmeans=True,
...
for patch in ax2.patches[1:10:4]:
    r, g, b, a = patch.get_facecolor()
    patch.set_facecolor((r, g, b, 1))
...
ax = sns.boxplot(x="site", y="gpp", hue="model_run", palette=my_pal_gpp, data=combined_gpp, flierprops=flp,
...
for patch in ax3.patches[1:10:4]:
    r, g, b, a = patch.get_facecolor()
    patch.set_facecolor((r, g, b, 1))
...
fig = plt.figure(layout="constrained", figsize=(14, 6))
ax3 = plt.subplot2grid(shape=(5, 1), loc=(0, 0), rowspan=4)
ax = sns.boxplot(x="site", y="gpp", hue="model_run", palette=my_pal_gpp_daily, data=combined_gpp_daily, flierprops=flp,
                 showmeans=True, meanprops={"marker": "o", "markerfacecolor": "white", "markeredgecolor": "black",
                                            "markersize": "4"},
                 medianprops=dict(color="grey", alpha=0.85, linewidth=1.9, linestyle='-'), linewidth=1.6,
                 saturation=0.8, showfliers=False)
...
ax3a = plt.subplot2grid(shape=(5, 1), loc=(4, 0), rowspan=1)
a1 = lme_fit_gpp_daily.summary().tables[1]
st_1 = a1['[0.025'][1:-1].values.astype('float')
st_2 = a1['0.975]'][1:-1].values.astype('float')
a = np.asarray([[[st_1[0], 1], [st_2[0], 1]], [[st_1[1], 2], [st_2[1], 2]], [[st_1[2], 3], [st_2[2], 3]],
                [[st_1[3], 4], [st_2[3], 4]], [[st_1[4], 5], [st_2[4], 5]]])
...
for label in ax3a.get_xticklabels():
    label.set_fontsize(15)
plt.show()
fig.savefig(bf / 'figure_4_c_daily.png', facecolor='white', transparent=False)
fig.savefig(bf / 'figure_4_c_daily.pdf', facecolor='white', transparent=False)
...
ax3 = plt.subplot2grid(shape=(5, 1), loc=(0, 0), rowspan=4)
ax = sns.boxplot(x="site", y="gpp", hue="model_run", palette=my_pal_gpp, data=combined_gpp, flierprops=flp,
                 showmeans=True, linewidth=1.6, saturation=0.8, showfliers=False,
                 meanprops={"marker": "o", "markerfacecolor": "white", "markeredgecolor": "black", "markersize": "4"},
                 medianprops=dict(color="grey", alpha=0.85, linewidth=1.9, linestyle='-'))
ax3.get_legend().remove()
sns.despine(offset=10, trim=True)
