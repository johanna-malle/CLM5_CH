...
fig1 = plt.figure(figsize=[9, 6.5])
ax0a = plt.subplot(331, projection=proj_map)
veg_global_05deg['__xarray_dataarray_variable__'].plot(transform=proj_data, cmap='viridis', add_colorbar=False,
...
ax1 = plt.subplot(332, projection=proj_map)
veg_global_025deg['__xarray_dataarray_variable__'].plot(transform=proj_data, cmap='viridis', add_colorbar=False,
                                                        vmin=min_all, vmax=max_all,
                                                        subplot_kws={'projection': proj_map})
